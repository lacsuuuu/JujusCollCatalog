    ...
    <>
      ...
      <div className="filter-bar" style={{ display: 'flex', gap: '0.75rem', marginBottom: '1rem', padding: '1.2rem', backgroundColor: '#D4C4C7', borderRadius: '10px', boxShadow: '0 2px 8px rgba(49,37,39,0.08)' }}>
        ...
        <input
          ...
          style={{ flex: 1, padding: '0.7rem 1rem', borderRadius: '6px', border: 'none', backgroundColor: '#C2B0B4', color: '#312527', fontSize: '0.95rem', outline: 'none', minWidth: 0 }}
        />
        <button
          onClick={resetFilters}
          style={{ padding: '0.5rem 1rem', cursor: 'pointer', backgroundColor: 'transparent', color: '#8D6E73', border: '2px solid #8D6E73', borderRadius: '6px', fontSize: '0.85rem', fontWeight: '600', whiteSpace: 'nowrap' }}
        >
          Reset
        </button>
        <button
          onClick={() => setShowAdvanced(!showAdvanced)}
          style={{ padding: '0.5rem 1.2rem', cursor: 'pointer', backgroundColor: showAdvanced ? '#8D6E73' : '#C2B0B4', color: showAdvanced ? '#FFF' : '#312527', border: 'none', borderRadius: '6px', fontSize: '0.85rem', fontWeight: '600', transition: 'all 0.2s', whiteSpace: 'nowrap' }}
        >
